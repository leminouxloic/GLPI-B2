					...
					<form class="form-horizontal" role="form" method="post" action="Traitment_Intra.php" >
						<div class="col-md-offset-1 col-md-10">
							...
							<div>
									...
									<label for="site" class="col-sm-4 control-label">Source de la demande <span style="color: red;">*</span> : </label>
										<div class="col-sm-5">
												<select placeholder="exemple" class="form-control" name="source" required="yes">
													<?php
														...
														if ($_GET['empty']=='yes') {
																...
																for($i=2; $i<=5; $i++) {
																	if ($_SESSION['source']==$sourcen[$i]) {
																		print('<option value="'.$sourcen[$i].'" selected="selected">'.$source[$i].'</option>') ;
																	}
																	else {
																		print('<option value="'.$sourcen[$i].'">'.$source[$i].'</option>') ;
																	}
